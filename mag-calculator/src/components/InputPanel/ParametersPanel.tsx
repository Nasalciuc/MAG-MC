...
export function ParametersPanel() {
  ...
  const toggleBudget = useMAGStore(s => s.toggleBudget);
  const tr = t(lang);
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <label
        className="flex items-center gap-3 cursor-pointer select-none text-sm font-semibold p-3 rounded-xl"
        ...
        <>
          ...
          <div>
            ...
            <input
              ...
              onChange={e => handleChange('productivitate', e.target.value)}
