...
export const en: Translations = {
  ...
  summary: { optDuration: 'Optimal duration (MAG)', magDuration: 'MAG duration', totalBudget: 'Total project budget', optOrders: 'Optimal orders', critActs: 'Critical activities', optimalOrder: 'Optimal order' },
  ...
  goldenRuleText: 'P2 and P3 start only after P1 on the same sector. P4 starts only after both P2 and P3. The 3 standard iterations (S1-S2-S3, S3-S2-S1, S1-S3-S2) are calculated; the optimal one is highlighted.',
  ...
  moreActions: 'More...',
  install: '📲 Install',
  showBudget: 'Calculate budget (N, B in cells)',
