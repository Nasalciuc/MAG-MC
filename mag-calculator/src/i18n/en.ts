...
export const en: Translations = {
  ...
  gfm: {
    ...
    day: 'Day', workersLabel: 'workers',
  },
  aoa: {
    title: 'AOA Diagram', events: 'Events', realArcs: 'Real arcs', dummyArcs: 'Dummy arcs',
    milestone: 'Event', eventNumber: 'Event no.', nodeFormat: 'Node format: t_e / t_l (earliest / latest time)',
  },
  budget: {
    ...
    breakdown: 'Breakdown', clickToExpand: 'Click budget for details', currencyUnit: 'k lei',
  },
