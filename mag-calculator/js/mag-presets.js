// ===== MAG PRESETS — Date predefinite pentru exemple =====
...
const MAG_PRESETS = {
  ...
  'exemplu_manual': {
    ...
    sectors: ['S1', 'S2', 'S3'],
    durations: {
      P1S1: 3, P1S2: 2, P1S3: 5,
      P2S1: 2, P2S2: 4, P2S3: 2,
      P3S1: 3, P3S2: 1, P3S3: 4,
      P4S1: 1, P4S2: 2, P4S3: 3
    },
    rata: 25,
    nrMunc: 12,
    productivitate: 2000
  ...
  'durate_egale': {
    ...
    sectors: ['S1', 'S2', 'S3'],
    durations: {
      P1S1: 3, P1S2: 3, P1S3: 3,
      P2S1: 2, P2S2: 2, P2S3: 2,
      P3S1: 2, P3S2: 2, P3S3: 2,
      P4S1: 1, P4S2: 1, P4S3: 1
    },
    rata: 30,
    nrMunc: 15,
    productivitate: 2000
...
function getPresetKeys() {
  return Object.keys(MAG_PRESETS);
}

function getPreset(key) {
  return MAG_PRESETS[key] || null;
}
